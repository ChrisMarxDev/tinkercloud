---
name: tiny-operator
description: Install, configure, diagnose, update, and recover a TinyHost server. Use for operator-owned Hetzner VPS setup, DNS, TLS, Resend, deployer authorization, status, doctor, signed updates, disk incidents, root recovery, and TinyHost security verification.
---
