...
const dataUsage = "usage: tiny data <kv|collections|documents> ..."
...
func dataRequestErrorFor(requestErr error, j bool, out, err io.Writer) int {
	...
	case errors.Is(requestErr, client.ErrUnauthorized):
		code, message = "not_authorized", "Data request is not authorized. Check app ownership; if this login predates data access, run tiny login --force."
