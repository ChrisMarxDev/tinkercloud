...
and the [V1 scope](docs/product/v1-scope.md).
...
Support does not include operating a VPS on someone else's behalf, recovering
data from a lost host, or promises for out-of-scope platforms. V1 has no
operator-facing backup system.
