...
| 14–20 | Upload flight | Four files accelerate in 5f offsets toward the Tinkercloud cloud | Custom accelerated file flight; no Gallery style key claimed |
...
| 24–28 | Brand resolve | Lock reaches edge-on width, swaps, and blooms into the Tinkercloud mark | Custom lock-to-brand squeeze, informed by `ui-to-brand-morph / icon-flip-bloom`; not a variant claim |
