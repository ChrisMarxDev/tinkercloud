      ...
      >
        <Window width={1160} height={640}>
          ...
          >
            ...
            >
              <span style={{color: TINKER.positive, fontSize: 25}}>●</span>
              https://my-tinker-app.example.com/
            </Pill>
            <div
              style={{
                display: "flex",
                ...
                padding: "38px 42px",
                borderRadius: 30,
                border: `2px solid ${TINKER.line}`,
                background: TINKER.surfaceRaised,
                boxShadow: TINKER.shadow,
              }}
            >
              <div
                style={{
