...
const fileTiles = [
  ...
  {name: "tiny.yaml", tone: "mint" as const, x: -370, y: 260, r: -13},
];
                ...
                {[1, 0.78, 0.9, 0.52].map((width, index) => (
                  <div
                    ...
                    style={{
                      ...
                      borderRadius: 99,
                      background:
                        index === 0 ? TINY.primary : "rgba(47,103,245,0.28)",
                    }}
                  />
                ))}
              </div>
