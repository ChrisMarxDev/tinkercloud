...
| [0012](0012-candidate-aware-activation-gates.md) | Candidate-aware immutable activation gates | Accepted |
| [0013](0013-confirmed-app-deletion.md) | Confirmed app deletion is a revocation-first lifecycle transition | Accepted for V1 |
...
| [0023](0023-policy-revision-concurrency.md) | Optimistic concurrency for access-policy replacement | Accepted for V1 |
