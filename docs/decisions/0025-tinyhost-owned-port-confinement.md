# ADR 0025: Confine TinyHost-owned network exposure to TCP 80 and 443

**Status:** Accepted for V1

## Context

TinyHost intentionally adds one Internet-facing gateway service to a dedicated
...
TinyHost-owned would broaden the product into host firewall and SSH management.
...
TinyHost's production network-exposure delta is exactly TCP ports 80 and 443.
...
non-loopback listener owned by TinyHost. It does not reject operator-owned
