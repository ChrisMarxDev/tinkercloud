...
TinyHost is a security-sensitive platform with a documented one-slice-per-
...
TinyHost does not yet have in-app feedback submission. Written GitHub issues
...
until TinyHost has a separately designed app capability for it.
...
- The loop adds no TinyHost listener, runtime dependency, product credential,
